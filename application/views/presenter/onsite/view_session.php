...
<link href="<?= base_url() ?>front_assets/presenter/view_session_onsite.css?v=17" rel="stylesheet">
<link href="<?= base_url() ?>front_assets/css/custom_onsite.css?v=17" rel="stylesheet">
...
<div class="container-fluid presenterContainer">
    <div class="row">
        <div class="col-lg-12 col-md-12 rightSide">
                ...
                <div class="content">
                    ...
                    <div class="row" style="width: 100%;">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" placeholder="Send Message" id="message" name="message" class="form-control">
...
<script src="<?= base_url() ?>front_assets/presenter/view_session_onsite.js?v=22"></script>
