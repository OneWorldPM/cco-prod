                ...
                <div class="card m-auto text-center">
                    <div class="row">
                        <div class="col-sm-12" style="margin: 30px 0px" >
                           ...
                           <div id="moderators" style="line-height: 1">
                            ...
                            <div style="height: 2px;background-color: #004290;" class="mb-5"></div>
                            ...
                            <a href="<?=base_url().'mobile/register'?>" class="btn btn-sm text-white" style="background-color:#004290">Create a new user</a>
                            <br><br>
                            <label style="">
                                Already have account ?
                                <a href="<?=base_url().'mobile/login/index/'.$this->session->userdata('sess_id')?>" class="" style="color:#004290;"> Login</a>
                            </label>
