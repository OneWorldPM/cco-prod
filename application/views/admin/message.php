            ...
            if ($val->message_status == 'presenter') {
                ...
                <li class="messages-item">
                    ...
                    if (isset($presenter_data) && !empty($presenter_data)) {
                        if ($presenter_data->presenter_photo != "") {
                            ?>
                            <img class="messages-item-avatar bordered border-primary" style="float:left" alt="" src="<?= base_url() ?>uploads/presenter_photo/<?= $presenter_data->presenter_photo ?>">
                        <?php } else { ?>
                        ...
                        <img class="messages-item-avatar bordered border-primary" style="float:left; height: 40px; width: 40px;" alt="" src="<?= base_url() ?>assets/images/Avatar.png">   
                    <?php } ?>        
                    <span class="messages-item-from" style="text-transform: capitalize !important"><?= (isset($presenter_data) && !empty($presenter_data)) ? $presenter_data->presenter_name : 'Presenter' ?></span>
                ...
                <li class="messages-item" style="">
                    ...
                    if (isset($customer_data) && !empty($customer_data)) {
                        ...
                        <?php } else { ?>
                            <img class="messages-item-avatar bordered border-primary" style="float:left" alt="<?= $customer_data->first_name ?>" src="<?= base_url() ?>assets/images/Avatar.png">
                            <?php
                        }
                    } else {
                        ?>
                        <img class="messages-item-avatar bordered border-primary" style="float:left" alt="" src="<?= base_url() ?>assets/images/Avatar.png">
                    <?php } ?>
