    ...
    <div class="container container-fullscreen" id="home_first_section">
        <div class="text-middle">
            <div class="row p-b-60 justify-content-center" style="text-align: center; justify-content: center">
                <div class="col-md-6 background-white col-md-offset-3" style="border-radius:5px; padding:2%" >
                <form id="frm_reg" name="frm_reg" method="post" action="<?= base_url() ?>register/add_customer">
                    ...
                    <div class="col-md-7 partition-right background-white" style="padding: 10px">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 style="padding-bottom: 3px; border-bottom: 2px solid #ebebeb; text-align:left">New Users Sign up Below</h5>
                            </div>
                        </div>
                        <div class="row">
...
<!--                        </div>-->
                        <div class="row">
                            <div class="col-md-12 form-group " style="text-align:left">
                                ...
                                <button class="btn btn-primary" id="btn_register" type="submit">Create</button>
                    ...
                    <div class="col-md-5" style="padding: 10px;">
                        <div>
                            <h5 style="padding-bottom: 3px; border-bottom: 2px solid #ebebeb; text-align: left">Returning Users Sign in Below</h5>
                            <?php
