                                ...
                                <div class="col-md-5" style="text-align: center;">
                                    ...
                                    if (isset($sessions->presenter) && !empty($sessions->presenter)) {
                                        foreach ($sessions->presenter as $value) {
                                            ?>
                                            <h3 style="margin-bottom: 0px;  cursor: pointer;" data-presenter_photo="<?= $value->presenter_photo ?>" data-presenter_name="<?= $value->presenter_name ?>" data-designation="<?= $value->designation ?>" data-email="<?= $value->email ?>" data-company_name="<?= $value->company_name ?>" class="presenter_open_modul" ><u style="color: #337ab7;"><?= $value->presenter_name ?></u><?= ($value->degree != "") ? "," : "" ?> <?= $value->degree ?><?= ($value->title != "") ? "," : "" ?> <?= $value->title ?></h3>
