...
<link href="<?= base_url() ?>front_assets/css/view_sessions_onsite.css?v=25" rel="stylesheet">
                                ...
                                <div class="modal-body view-session-user-modal-body" style="padding: 0px; content" id="content">
                                    <div class="row" style="padding-top: 0px; padding-bottom: 20px; margin-left:5px">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="row" id="rowLivePoll" style="margin-left:10px;text-align:left; font-size: 20px; font-weight: 700; margin-top:10px;"> <img style="margin-top:-13px" src="<?=base_url()?>front_assets/images/cco_sm.png" height="25px"><span> LIVE POLL</span>
        ...
        <div class="rightSticky" data-screen="customer">
            <ul>
                ...
                if(sessionRightBarControl($sessions->right_bar, "chat")){
                    ?>
                    <li data-type="messagesSticky"><i class="fa fa-comments" aria-hidden="true"></i> <span class="notify notify<?=getAppName($sessions->sessions_id) ?> displayNone"></span> <span>Chat</span></li>
                    <?php
                }
...
<!--                <span class="glyphicon glyphicon-option-vertical" aria-hidden="true" data-toggle="dropdown"></span>-->
                <ul class="dropdown-menu">
                    ...
                    if(sessionRightBarControl($sessions->right_bar, "chat")){
                        ?>
                        <li data-type="messagesSticky"><a data-type2="off">Chat</a></li>
                        <?php
                    }
                    if(sessionRightBarControl($sessions->right_bar, "questions")){
                        ?>
